...
class AppConfig {
  ...
  factory AppConfig.fromMap(Map<String, dynamic> map) {
    return AppConfig(
      ...
      bobotKelasBesar: (map['bobotKelasBesar'] as num?)?.toDouble() ?? 0.0,
      bobotRoomQudwah: (map['bobotRoomQudwah'] as num?)?.toDouble() ?? 0.0,
      bobotTugas: (map['bobotTugas'] as num?)?.toDouble() ?? 0.0,
      nilaiMinimum: (map['nilaiMinimum'] as num?)?.toDouble() ?? 0.0,
